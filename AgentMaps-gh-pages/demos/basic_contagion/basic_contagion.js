...
var bounding_box = [[39.9230010966, 116.4026784], [39.91319258, 116.4152526]];
	/* [39.9230010966, 116.4026784], [39.91319258, 116.4152526]];
...
function setup() {
	...
	agentmap.buildingify(bounding_box, map_data, undefined, {"color": "blue", "weight": 1.5, "opacity": .6}, units_data, streets_data);
	...
	agentmap.agentify(300, agentmap.seqUnitAgentMaker);
